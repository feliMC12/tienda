...
<html lang="en">
	...
	<head>
		...
		<title>Blog News - Neoncart HTML5 Template</title>
						...
						<div class="col-lg-6 col-md-6">
							<div class="blog_grid">
								...
								<div class="blog_content">
									...
									<a class="custom_btn bg_default_black text-uppercase" href="blog_details.html">Read More <i class="fal fa-arrow-circle-right ml-2"></i></a>
								</div>
							</div>
						</div>
